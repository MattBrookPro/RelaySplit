...
CI-able regression test for the whole data plane (WebRTC + TURN + streaming SCNet separation).
...
async def roundtrip(target: str, seconds: float = 12.0):
    ...
    # Pre-warm the GPU container — its first request cold-loads the model (~15-30 s); without this the
